    ...
    return (
        ...
        <div id="About-Me" className="container-about py-5">
            ...
            <div className="row">
                ...
                <div className="about-para col-lg-6 col-xm-12" /* creates a column space on the first half of the page from left to right (so the left side here) */ >
                ...
                <div className="entire-img col-lg-6 col-xm-12" /* the right side here */ >
